...
function Features() {
  ...
  return (
    <div  
        data-color="salmon" 
        ref={container} 
        className="features section sm:w-full  px-8 sm:px-8 mt-32"
    >
      <div 
        ...
        >
            ...
            >
                ...
                <div className='w-[60%] text-center font-[SansitaReg] relative'>
                    ...
                    >
                        We go beyond training. Our career services include portfolio reviews, interview prep, and connections with industry professionals.
                    </h3>
                    ...
                    <h3 className=' text-[2vh] sm:text-[5vh] font-semibold sm:leading-[7vh]'>
                        Get the support you need to land your dream job in tech.
                    </h3>    
                </div>
                <div 
            ...
            >
                ...
                <div className='w-[60%] text-center font-[SansitaReg] relative'>
                    ...
                    <h3 className='text-[3.5vh] whitespace-nowrap sm:text-[6vh] font-semibold sm:leading-[6vh]'>
                        Learn at your own pace with flexible online programs.
                    </h3>    
                </div>
                <div 
