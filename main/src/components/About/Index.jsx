...
function About() {
  ...
  return (
    <div 
        data-color="cyan" 
        className="about section w-full sm:flex gap-x-40 justify-between 
    ...
    >
        <div className="ltext sm:sticky sm:top-[10%] left-0 sm:w-1/2 ">
            ...
            <h1 className="texthead font-[SansitaReg] text-[5vh] leading-[6vh] sm:text-[9.8vh] sm:leading-[12vh] mt-10 mb-10">WHO WE ARE</h1>
            {/* button */}
            <Button  bgColor="bg-none" text="KNOW MORE" />
        </div>
        <div
            ref={container} 
